...
const fallback: NonNullable<ApiPayload["reviews"]> = [
  {
    text: "Atendimento impecável e um resultado lindo. Senti-me mesmo cuidada do início ao fim.",
    authorName: "Ana",
    rating: 5,
    relativeTime: "",
    authorUrl: "",
  ...
  {
    text: "As tranças ficaram perfeitas e super confortáveis. Vou voltar sem dúvida!",
    authorName: "Marta",
    rating: 5,
    relativeTime: "",
    authorUrl: "",
  ...
  {
    text: "Corte e cor exactamente como eu queria. Muito profissional e com bom gosto.",
    authorName: "Rita",
    rating: 5,
    relativeTime: "",
    authorUrl: "",
...
export default function ReviewsSection() {
  ...
  return (
    <section className="px-4 py-12">
      <div className="mx-auto w-full max-w-5xl">
        ...
        {data?.ok && placeName ? (
          <div className="mt-6 flex flex-wrap items-center justify-between gap-3 rounded-2xl border border-black/10 bg-white/30 px-4 py-3">
            <div className="flex items-center gap-3">
              <span className="text-[12px] font-semibold tracking-[0.18em] text-[#2f2d2d]">
                {placeName}
              </span>
              <span className="text-[12px] text-[#2f2d2d]/70">
                {Number(placeRating || 0).toFixed(1)} ★
              </span>
  ...
  {list.map((r, idx) => (
    <div
      ...
      className="soft-card glass mb-6 break-inside-avoid rounded-[28px] p-5"
    >
                ...
                <div className="mt-4 flex items-center justify-between gap-3">
                  {r.authorUrl ? (
                    ...
                    <p className="text-[13px] font-semibold tracking-[0.06em] text-[#2f2d2d]">
                      {r.authorName}
                    </p>
                  )}
